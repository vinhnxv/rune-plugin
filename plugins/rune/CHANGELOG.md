...
- **Echo Search MCP expansion**: Added `mcpServers: echo-search` to 36 agents with tailored Echo Integration sections. Enables direct FTS5 query access to past learnings across all workflow phases:
  ...
  - **Utility** (3/9): decree-arbiter (past project knowledge), knowledge-keeper (past documentation gaps), horizon-sage
