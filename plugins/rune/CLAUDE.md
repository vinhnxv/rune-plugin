...
| `/rune:arc` | End-to-end pipeline with freshness gate (forge → plan review → refinement → verification → freshness check → work → gap analysis → review → mend → verify mend → audit) |
