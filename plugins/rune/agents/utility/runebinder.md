...
2. Deduplicate findings using the hierarchy: SEC > BACK > DOC > QUAL > FRONT > CDX
...
| Same severity | Keep by hierarchy: SEC > BACK > DOC > QUAL > FRONT > CDX |
